...
class MetamaskErrors extends React.Component {
  ...
  render() {
    ...
    if(this.props.metamask.eth_address == null){
      error = (<p className='alert-info'>Please ensure MetaMask is unlocked and set to the Kovan test network. Read our <a href="/faq#question_2" target="_blank">FAQs</a> to learn more about Metamask.</p>)
